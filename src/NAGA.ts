...
// 		const element = await page.waitForSelector('div.elementor-tabs');
// 		if (!element) return null;
// 		await element.scrollIntoView();
// 		await page.locator('div ::-p-text(Travel)').click();
// 		const frame = await page.waitForSelector('iframe#stay22-widget');
